    ...
    <div class="limiter">
        <div class="container-login100">
            <div class="wrap-login100">
                <div class="vLogo">
                    <a href="../Página Principal/index.php" class="seta"><img src="../images/botao-de-seta-para-a-esquerda-do-teclado.png" alt=""></a>
                ...
                <form class="login100-form validate-form" action="" method="post">
                    <span class="login100-form-title">Completar Cadastro</span>
            ...
            Data de Nascimento
                    ...
                    <div class="text-center p-t-136">
						...
						<a class="txtC" href="Gerente/index.php">
							Sou Empresa
						</a>
					</div>
                </form>
